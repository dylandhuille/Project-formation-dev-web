    ...
    <div class="row ">
        <div class="col-sm-12 col-lg-4">
            ...
            <div class="form-group">
                ...
                <input id="disabledProperty" name="disabledProperty" type="hidden" value="true">
                <button type="submit" value="Submit" class="btn btn-danger btn-default" id="disabledBtn">Désactivé l'annonce </button>
            </form>
        </div>
    </div>
</div>
